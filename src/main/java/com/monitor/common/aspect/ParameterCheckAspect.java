...
import com.monitor.common.annotation.Log;
...
public class ParameterCheckAspect {
    ...
    @Pointcut("execution(* com.monitor.business.controller..*(..))  ")
    public void aspect() {
    }
    ...
    public Object validationPoint(ProceedingJoinPoint pjp)throws Throwable{
        ...
        //boolean  isParamXssPassEmpty  = Objects.isNull(method.getAnnotation( ParamXssPasss.class ));
