...
public class JobUtil {
    ...
    public String addJob(AppQuartz appQuartz) throws Exception  {
        ...
        /*if("JobOne".equals(appQuartz.getJobGroup())) {
            jobDetail = JobBuilder.newJob(HelloJob.class).withIdentity(appQuartz.getJobName(), appQuartz.getJobGroup()).build();
        }
        if("JobTwo".equals(appQuartz.getJobGroup())) {
            jobDetail = JobBuilder.newJob(NewJob.class).withIdentity(appQuartz.getJobName(), appQuartz.getJobGroup()).build();
        }*/
        jobDetail = JobBuilder.newJob(JobConstants.JOB_MAP.get(appQuartz.getJobClassName())).withIdentity(appQuartz.getJobName(), appQuartz.getJobGroup()).build();
